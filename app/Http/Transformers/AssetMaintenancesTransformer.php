...
class AssetMaintenancesTransformer
{
    ...
    public function transformAssetMaintenance(AssetMaintenance $assetmaintenance)
    {
        $array = [
            ...
            'rma' => ($assetmaintenance->rma) ? ['id' =>  $assetmaintenance->rma->id, 'rma_number' => ($assetmaintenance->rma->rma_number) ? e($assetmaintenance->rma->rma_number) : null, 'case_number' => ($assetmaintenance->rma->case_number) ? e($assetmaintenance->rma->case_number) : null] : null,
