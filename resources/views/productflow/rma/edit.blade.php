...
@section('inputFields')
    ...
    @include ('partials.forms.edit.asset-select', [
        'translated_name' => trans('admin/rma/form.asset'),
        'fieldname' => 'asset_id',
        'required' => 'true',
    ])
    ...
    <div class="form-group {{ $errors->has('contact') ? ' has-error' : '' }}">
        ...
        <div class="col-md-8{{ Helper::checkIfRequired($item, 'contact') ? ' required' : '' }}">
            <input class="form-control" type="text" name="contact" class="col-md-6 form-control" id="contact"
    ...
    @if (isset($item->id))
        ...
        <div class="form-group {{ $errors->has('rma_number') ? ' has-error' : '' }}">
            ...
            <div class="col-md-2{{ Helper::checkIfRequired($item, 'rma_number') ? ' required' : '' }}">
                <input class="form-control" type="text" name="rma_number" class="col-md-6 form-control" id="rma_number"
                    value="{{ old('rma_number', $item->rma_number) }}" />
                {!! $errors->first(
                    'rma_number',
                    '<span class="alert-msg" aria-hidden="true"><i class="fas fa-times" aria-hidden="true"></i> :message</span>',
                ) !!}
        ...
        <div class="form-group {{ $errors->has('case_number') ? ' has-error' : '' }}">
            ...
            <div class="col-md-2{{ Helper::checkIfRequired($item, 'case_number') ? ' required' : '' }}">
                <input class="form-control" type="text" name="case_number" class="col-md-6 form-control" id="case_number"
                    value="{{ old('case_number', $item->case_number) }}" />
                {!! $errors->first(
                    'case_number',
                    '<span class="alert-msg" aria-hidden="true"><i class="fas fa-times" aria-hidden="true"></i> :message</span>',
                ) !!}
            ...
            <div class="input-group col-md-3{{ Helper::checkIfRequired($item, 'start_date') ? ' required' : '' }}">
                <div class="input-group date" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-autoclose="true"
                    ...
                    <input type="text" class="form-control" placeholder="{{ trans('general.select_date') }}"
                        name="start_date" id="start_date" value="{{ old('start_date', $item->start_date) }}">
        ...
        <div class="form-group {{ $errors->has('completion_date') ? ' has-error' : '' }}">
            ...
            <div
                class="input-group col-md-3{{ Helper::checkIfRequired($item, 'completion_date') ? ' required' : ' required' }}">
        ...
        <div class="form-group">
            <div class="col-md-7 col-md-offset-3">
                <label for="with_admin" class="form-control">
                    <input type="checkbox" name="with_admin"
                        {{ old('with_admin', $item->with_admin) == '1' ? ' checked="checked"' : '' }}
                        aria-label="with_admin">
        ...
        <div class="form-group">
            <div class="col-md-7 col-md-offset-3">
                <label for="warranty_expired" class="form-control">
                    <input type="checkbox" name="warranty_expired"
                        {{ old('warranty_expired', $item->warranty_expired) == '1' ? ' checked="checked"' : '' }}
                        aria-label="warranty_expired">
        ...
        <div class="form-group {{ $errors->has('repair_cost') ? ' has-error' : '' }}">
            ...
            <div class="col-md-3{{ Helper::checkIfRequired($item, 'repair_cost') ? ' required' : '' }}">
                <input class="form-control" type="text" name="repair_cost" id="repair_cost" placeholder="$"
                    value="{{ old('repair_cost', $item->repair_cost) }}" />
                {!! $errors->first(
                    'repair_cost',
                    '<span class="alert-msg" aria-hidden="true"><i class="fas fa-times" aria-hidden="true"></i> :message</span>',
                ) !!}
        ...
        @include('partials.forms.edit.new-asset-select', [
            'translated_name' => trans('admin/rma/form.new_asset'),
