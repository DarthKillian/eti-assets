            ...
            <div class="box box-default">
                                    ...
                                    <div class="col-md-3 text-right" style="padding-right: 10px;">
                                        @if(Route::is('rma.create'))
                                            <a href="{{ route('productflow.receiving', ['new_rma' => 1]) }}"
                                                class="btn btn-sm btn-primary pull-right" id="newAssetBtn">
                ...
                <div class="box-body">
                    ...
                    <div style="padding-top: 30px;">
                        ...
                        {{ csrf_field() }}
                        @yield('inputFields')
                        <x-redirect_submit_options :index_route="$index_route ?? null"
                            :button_label="trans('general.save')" :options="$options ?? []" />
                    </div>
