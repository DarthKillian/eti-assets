...
<<<<<<< HEAD
    'support_url_help' => 'Variáveis <code>{LOCALE}</code>, <code>{SERIAL}</code>, <code>{MODEL_NUMBER}</code>, e <code>{MODEL_NAME}</code> pode ser usado na URL para ter esses valores auto-preenchidos quando estiver visualizando assets - por exemplo, https://support. pple.com/{LOCALE}/{SERIAL}.',
=======
